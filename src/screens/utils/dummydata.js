...
export const franchiseBestData = [
  ...
  {
    discrption:
      "Our support includes Talent Acquisition, Training, Operational Strategies, Marketing, Public Communication, and Customer Care Assistance throughout our partnership.",
  },
  {
    discrption:
